...
END;
// l'utilisateur a entré un type de garde
if (isset($_GET['type'])){
if($_GET['type']=='occ') {//la garde est occsionnelle
  //l'utilisateur recoit un formulaire pour entrer le jour et lheure de la garde et ses enfants concernés
  ?>


  <form method="get" action="">
<input type ="hidden" name= 'type' value='occ'>
  <div class="row">
...
<div class="row center">
 ...
 <a href="../index.php" class="btn waves-effect waves-light left  pink lighten-1">Retour</a>
 </div>
  </div>
</div>
</form>
...
<?php if (isset($_GET['date'])) {
  //l'utilisateur a entré une date
